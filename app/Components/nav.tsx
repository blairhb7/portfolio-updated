        ...
        <nav className=' flex justify-between py-4 px-2 uppercase'>
           <Link href={'/'}> 
                 <div className="flex flex-col">
                    <h1 id='logo' className=" text-[.5em] md:text-base px-1 font-medium leading-tight text-white shadow-black outline">Blair Chappell <br/> <span className=' text-xslg:text-base'>frontend developer</span></h1>
                 </div>
            </Link>
            <div className="">
            <header>
